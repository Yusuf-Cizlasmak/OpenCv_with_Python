...
#şimdi de kameradan görüntüdeki kontrol etmek için while döngüsü oluşturuyorum""" #şu kodların hepsi sarı rengin lower ve upper'ını bulmak içindi 
while True:
    ret,frame = cap.read()
    frame= cv2.flip(frame,1) # aynadaki gibi görmemiz için.
    ...
    mask= cv2.inRange(frame,lower_Color,upper_Color) #maskelemek için 3 tane değişkenimi girdim.
